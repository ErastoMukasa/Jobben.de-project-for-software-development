...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:@localhost/jobben_database'
...
def edit_job(job_id):
    ...
    job.latitude = request.form.get('latitude')
    job.longitude = request.form.get('longitude')
...
# Initialize and create the admin user
with app.app_context():
    db.create_all()
    create_admin_user()
